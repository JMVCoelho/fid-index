...
initial_model=./models/t5-base-marco-2048-scaled #-marco-pretrain

first_trained_model_name=t5-base-$split-firstp-marco-pretrain-$text_length
...
/home/jcoelho/.conda/envs/openmatch/bin/accelerate launch --num_processes $n_gpus OpenMatch/src/openmatch/driver/train_dr.py  \
